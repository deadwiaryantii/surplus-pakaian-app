...
export default function SanitasiQCPage() {
  ...
  return (
    <div className="space-y-6 w-full max-w-full overflow-hidden">
      <div>
        <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Sanitasi & Final QC</h2>
        <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Pencatatan proses kebersihan, sterilisasi, dan penetapan status siap distribusi.</p>
      </div>
