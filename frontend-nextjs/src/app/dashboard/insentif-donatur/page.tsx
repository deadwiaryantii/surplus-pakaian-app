  ...
  return (
    <div className="space-y-6 w-full max-w-full overflow-hidden">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Insentif & Apresiasi Donatur</h2>
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">Pencatatan pemberian apresiasi kepada donatur berdasarkan transaksi surplus.</p>
        </div>
        <button
                ...
                <tr key={item.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition">
                  <td className="py-4 px-6 font-medium text-slate-800 dark:text-slate-200">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="truncate">{item.donatur}</span>
                    </div>
                  </td>
                  <td className="py-4 px-6 font-mono text-xs text-emerald-600 dark:text-emerald-400 whitespace-nowrap">{item.transaksi}</td>
                  <td className="py-4 px-6 font-semibold text-slate-800 dark:text-slate-200">{item.nominal}</td>
                  <td className="py-4 px-6 text-slate-600 dark:text-slate-400 whitespace-nowrap">{item.tanggal}</td>
