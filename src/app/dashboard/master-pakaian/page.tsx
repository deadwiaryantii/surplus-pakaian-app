...
import { Shirt, Plus, Edit, Trash2, Tag } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Master Data Pakaian</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400">Pencatatan seragam jenis, ukuran, warna, bahan, dan kondisi pakaian surplus[cite: 1, 2].</p>
        </div>
        <button
