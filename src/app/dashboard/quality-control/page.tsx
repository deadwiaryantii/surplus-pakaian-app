...
import { CheckCircle2, XCircle, ShieldCheck, Hash, PackageCheck } from "lucide-react";
...
export default function QualityControlPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-slate-800 dark:text-slate-100">Quality Control (QC) Barang Masuk</h2>
        <p className="text-sm text-slate-500 dark:text-slate-400">Pemeriksaan kondisi fisik pakaian surplus dan validasi kelayakan sebelum masuk gudang[cite: 1, 2].</p>
      </div>
